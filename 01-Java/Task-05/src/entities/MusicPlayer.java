...
public class MusicPlayer {
    ...
    String filePathIntro = "src/musicaintro.wav";
    String filePathBattle = "src/musicabatalha.wav";
    String filePathGameOver = "src/gameover.wav";
    String filePathWin = "src/musicavitoria.wav";
