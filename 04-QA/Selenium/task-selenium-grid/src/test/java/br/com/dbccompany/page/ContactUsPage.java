...
public class ContactUsPage extends Interactions {
    ...
    public void clicarParaFazerUpload(){
        String filePath = "C:\\DBC\\vs14-qa\\04-QA\\Selenium\\task-selenium-grid\\src\\main\\resources\\pagina.png";
        driver.get().findElement(By.cssSelector("#fileUpload")).sendKeys(filePath);
    }
